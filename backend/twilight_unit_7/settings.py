"""
Django settings for twilight_unit_7 project.
...
ROOT_URLCONF = 'twilight_unit_7.urls'
...
WSGI_APPLICATION = 'twilight_unit_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "twilight_unit_7 API",
    "DESCRIPTION": "API documentation for twilight_unit_7 App",
    "VERSION": "v1",
}
